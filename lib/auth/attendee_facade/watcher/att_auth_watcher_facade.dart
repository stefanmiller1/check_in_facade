...
abstract class ATTAuthWatcherFacade {
  ...
  Stream<Either<AttendeeFormFailure, List<AttendeeItem>>> watchUserProfileAttending({required ContactStatus? status, required AttendeeType? attendingType, required int? limit, required String? userId});
