...
abstract class RAuthWatcherFacade {
  ...
  Stream<Either<ReservationFormFailure, List<ReservationItem>>> watchCurrentUserReservationItem({required UserProfileModel currentUser, required bool isResInvitation});
